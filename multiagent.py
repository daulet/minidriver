...
def main(env_name, path1, path2, render, rounds):
  model1, model2 = get_model(path1), get_model(path2)
  print("Testing model...")
  test(env_name, model1, controllers=[Controller(model2)], render=render, rounds=rounds) 
...
if __name__ == "__main__":
  ...
  main(f"driver_planning:{args.env_name}-v0", args.path1, args.path2, not args.headless, args.rounds)
